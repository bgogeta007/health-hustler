  ...
  const benefits = [
    {
      ...
      description: 'Get diet and exercise plans tailored to your unique needs, goals, and preferences.'
    },
    {
    ...
    },
    {
      ...
      description: 'Access workout routines designed to maximize results while fitting into your schedule.'
    },
    {
  ...
  const testimonials = [
    {
      ...
      role: 'Lost 25 lbs',
      testimonial: 'HealthHustler transformed my approach to weight loss. The personalized plan made all the difference!'
    },
    {
      name: 'Michael Chen',
      image: 'https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=600',
      role: 'Lost 30 lbs',
      testimonial: 'The quiz matched me with the perfect diet plan. I\'ve never felt better or had more energy!'
    },
    {
      name: 'Alicia Rodriguez',
      image: 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=600',
      role: 'Lost 15 lbs',
      testimonial: 'Finally found a healthy eating plan I can stick to. The recipes are delicious and easy to make.'
    }
  ];
  ...
  return (
    <div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            >
              Your Journey to a <span className="text-green-400">Healthier You</span> Starts Here
            </motion.h1>
            ...
            >
              Discover personalized diet plans and weight loss strategies tailored just for you. 
              All completely free, no subscriptions required.
            </motion.p>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-700">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-300 mb-4">How It Works</h2>
            <p className="text-lg text-gray-600 dark:text-gray-200 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                number: '02',
                title: 'Get Your Plan',
                description: 'Receive a customized diet and exercise plan tailored to your unique needs.'
              },
              {
                number: '03',
                title: 'Start Your Journey',
                description: 'Follow your plan and track your progress as you work toward your goals.'
              }
            ].map((step, index) => (
              <motion.div 
                key={index}
                ...
                viewport={{ once: true }}
              >
                <div className="text-5xl font-bold text-green-200 dark:text-green-400 absolute top-0 left-0">{step.number}</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-lg mb-8">
              Start your journey to a healthier you today. Take our quick quiz to get your personalized plan.
            </p>
            <Link 
              to="/quiz" 
